...
#assume table is already complete 
#RWM table: 
...
# # STEP 6b: Write new table 
# from new_table2 import * # import all functions from this script 

# save_name= 'appended_table.csv'
# print('Writing new table...')
# t1 = time.time()

# write_new_table(os.path.join(OUTPUT_PATH, DATASET,'features'), save_name,  OUTPUT_PATH, DATASET,FRAMES)

print("STEP-6b NEW TABLE: " + str(time.time() - t1))   

# if seg =='y' or seg == 'yes': 
#     print('DeepTiming with Segmentation Complete.')

# print("STEP-7 CELL FEATURE COMBINING COST: " + str(time.time() - t1))   
